...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('roles')->insert([
            ...
            ['name'=>'Checker','slug_name'=>'checker','description'=>'Có vai trò kiểm duyệt bình luận của user, có quyền hành ít hơn và bị kiểm soát bởi Super Administrator và Administrator','level'=>'3','created_at'=>$mytime->toDateTimeString(),'updated_at'=>$mytime->toDateTimeString()],
