...
@section('content')
    ...
    <div class="row" id="app">
        <div class="col-md-12">
            <div class="white-box">
                <form class="form-horizontal" method="post" action="{{ route('mangas.store') }}" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <select class="select2 m-b-10 select2-multiple" multiple="multiple" data-placeholder="Chọn nhóm dịch" name="teams[]">
                    ...
                    <div class="row mt-5">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="file" id="input-file-now" name="cover" class="dropify" required />
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
@section('custom_js')
    <script src="{{ asset('js/manga-create.js') }}"></script>
@endsection